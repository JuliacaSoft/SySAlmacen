 ...
 * @author AngelDX
 */
@WebServlet(name = "ProductoServelt", urlPatterns = {"/ProductoServelt"})
public class ProductoServelt extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          String cen=request.getParameter("txtCencos");
          int can=Integer.parseInt(request.getParameter("txtCantidad"));
          double imp=Double.parseDouble(request.getParameter("txtImporte"));
          
          
          ProductosMamanger operacion=new ProductosMamanger();
          Productos producto1=new Productos(cod,des,cen,can,imp);        
